  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground p-4">
      ...
      <main className="flex-grow">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">Initialize Duty</h1>
        ...
        <div className="mt-8">
          <h2 className="font-semibold mb-3">Recent Offline Access</h2>
          <Card className="bg-card border-orange-500/50 border-2">
