...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 antialiased relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <footer className="absolute -bottom-16 text-center text-xs text-muted-foreground">
