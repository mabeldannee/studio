    ...
    <div className="flex flex-col min-h-screen w-full bg-background">
      ...
      <footer className="fixed bottom-0 left-0 right-0 bg-card border-t p-2 shadow-[0_-1px_10px_rgba(0,0,0,0.05)]">
        <nav className="flex justify-around items-center max-w-md mx-auto">
          <Link href="/passenger/overview" className="flex flex-col items-center gap-1 text-muted-foreground hover:text-primary">
            <Home className="h-6 w-6" />
            <span className="text-xs font-medium">Home</span>
          </Link>
          <Link href="/passenger/verification" className="flex flex-col items-center gap-1 text-primary">
