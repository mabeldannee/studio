      ...
      <TooltipProvider>
        <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
          ...
          >
            ...
            <span className="sr-only">RailAssist AI</span>
          </Link>
          <Tooltip>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                <span className="sr-only">Trains</span>
              </Link>
            </TooltipTrigger>
            <TooltipContent side="right">Trains</TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
            ...
            <TooltipContent side="right">Verification</TooltipContent>
          </Tooltip>
           <Tooltip>
            <TooltipTrigger asChild>
              <Link
              ...
              >
                <Users className="h-5 w-5" />
                 <Badge variant="destructive" className="absolute -top-1 -right-2 h-4 w-4 !p-0 justify-center text-xs">3</Badge>
                <span className="sr-only">Passengers</span>
              </Link>
            </TooltipTrigger>
            <TooltipContent side="right">Passengers</TooltipContent>
          </Tooltip>
        </nav>
